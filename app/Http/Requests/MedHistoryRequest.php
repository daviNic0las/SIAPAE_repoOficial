...
class MedHistoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'do_AEE' => 'required|boolean',
            'class_AEE' => 'nullable|string|max:255',
            ...
            'compplaint' => 'nullable|string|max:255',
            ...
            'lives_new_relation_mother' => 'nullable|string|max:255',
            'new_relation_father' => 'required|boolean',
            'time_new_relation_father' => 'nullable|string|max:255',
            'lives_new_relation_father' => 'nullable|string|max:255',
