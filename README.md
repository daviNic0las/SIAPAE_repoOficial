...
1.4 Contexto e motivação: 
O propósito do SIAPAE é simplificar e digitalizar processos na APAE (ex. Anamnese, registro de alunos, etc.), demanda essa que surgiu com a alta taxa de informações a serem preenchidas fisicamente. O SIAPAE traz benefícios como: otimização do tempo, economia de papel e diminuição na sobrecarga de trabalho.