...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'have_medication' => 'toma medicação',
        'who_lives' => 'com quem mora',
        'state_parents_relation' => 'estado da relação dos pais',
        'new_relation_mother' => 'mãe tem nova relação',
        'new_relation_father' => 'pai tem nova relação',
        'have_kinship_parents' => 'os pais são parentes',
        'have_child_desired' => 'criança desejada',
        'child_adopted' => 'criança adotada',
        'gestation_order' => 'ordem da gestação',
        'number_children' => 'número de filhos',
        'history_abort' => 'histórico de aborto',
        'have_pre_natal' => 'fez pré-natal',
        'time_gestation' => 'duração da gestação',
        ...
        'have_discharged_together' => 'teve alta junto com a mãe',
        'have_neonatal_tests' => 'fez testes neonatais',
        'have_mother_breastfeed' => 'a mãe amamentou',
        'have_nozzle' => 'usa bico',
        'have_delay_NPM' => 'possui atraso no desenvolvimento',
        'have_normal_development' => 'desenvolvimento normal',
        'have_desfrald_yet' => 'já desfraldou',
        'have_sphincters_control' => 'controle de esfíncteres',
        'bites_nails' => 'roê as unhas',
        'hurt_yourself' => 'machuca a si mesmo',
        'state_sleep' => 'estado do sono',
        'sleeps_in_separate' => 'dorme separado',
        ...
        'shyness' => 'timidez',
        'affectionate' => 'afetividade',
        'inappropriate_behavior' => 'comportamento inapropriado',
        'tics_manias' => 'tiques e manias',
        'hyperfocus' => 'hiperfoco',
        'waiting_skill' => 'habilidade para esperar',
        'tolerates_frustration' => 'tolera frustração',
        ...
        'age_start_school' => 'idade ao iniciar escola',
        'how_school_adaptation' => 'como foi a adaptação escolar',
        'have_difficulty_learning' => 'tem dificuldade de aprendizado',
        ...
        'complaint_behavior' => 'reclamação de comportamento',
        'demonstrates_satisfaction_school' => 'demonstra satisfação com a escola',
        'report_situation_school_in_home' => 'relato da situação escolar em casa',
        'knows_handle_pencil' => 'sabe manusear lápis',
        'reading_letters' => 'lê letras',
        'reading_words' => 'lê palavras',
        'reading_texts' => 'lê textos',
        ...
        'have_therapeutic' => 'faz terapia',
        'history_disorders_family' => 'histórico de transtornos na família',
        'have_update_vaccines' => 'vacinas em dia',
        'relation_family_members' => 'relação com membros da família',
        'super_protected' => 'superprotegido',
        'have_access_cellphone' => 'tem acesso ao celular',
        'already_had_information_institution' => 'já teve informações sobre a instituição',
        'participate_contribution' => 'participa de contribuição',
    ],
