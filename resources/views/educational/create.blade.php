    ...
    <x-table-create
        ...
        <div class="mb-3 grid grid-cols-4 gap-x-4">
            <div class="col-span-2">
                ...
                <x-form.input id="school" name="school" value="{{old('school')}}" class="w-full" required
            ...
            <div class="col-span-1">
                ...
                <x-form.input id="date_of_birth" name="date_of_birth" readonly
            ...
            <div class="pl-4 col-span-1">
                ...
                placeholder="Ex: 15 anos" class="w-48"/>
                @error("age")
                    <span class="text-red-600 dark:text-red-400">{{$message}}</span>
                @enderror
            </div>
        ...
        <div class="mb-3 grid grid-cols-4 gap-x-4 gap-y-3">
            <div>
                ...
                placeholder="Ex: Manhã" class="w-full"/>
                @error("age")
                    <span class="text-red-600 dark:text-red-400">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="col-span-2">
                ...
                <x-form.select idSelect="professor_signature" valueName="professor_signature" full>
                    ...
                    @foreach ($users as $user)
                        <option value="{{$user->name}}" {{old('professor_signature') == $user->name ? 'selected' : ''}}>
                            {{$user->name}}
                        </option>
                    @endforeach
                </x-form.select>
