<x-app-layout>
    ...
    <x-table-edit 
        ...
        <div class="mb-3">
            ...
            <x-form.input id="name" type="text" name="name" value="{{ old('name', $student->name) }}" class="w-full dark:text-gray-400"
                placeholder="Ex: João" />
        ...
        <div class="flex justify-between mb-3">
            <div class="flex-1">
                ...
                Selecione a Turma e o Turno realizados na Apae:
                </label>
                <x-form.select valueName="class_apae">
                    <option value=""> Selecione o Turma realizado na Apae: </option>
            ...
            <div class="flex-1 justify-end">
                <div class="block text-white dark:text-gray-800 font-normal mb-2">.</div>
        ...
        <div class="mb-3">
            ...
            <x-form.input id="date" type="text" name="date_of_birth" value="{{ old('date_of_birth', $student->date_of_birth) }}"
        ...
        <div class="flex mb-3">
            <div class="flex-1 pr-2">
                ...
                <x-form.input id="class_school" type="text" name="class_school" value="{{ old('class_school', $student->class_school) }}"
            ...
            <div class="flex-1 px-2">
                ...
                <x-form.input id="grade_school" type="text" name="grade_school" value="{{ old('grade_school', $student->grade_school) }}"
        ...
        <div class="mb-3 mt-4">
            <div class="flex items-center">
                ...
                <input id="file-upload" type="file" name="image" value="{{ old("image", $student->image) }}" class="hidden"
                    onchange="updateImageLabel(event) updateImagePreview(event)">
            ...
            <img id="image-preview" class="rounded-full w-32 h-32 imagemfulera" src="{{ asset('img/student/' . $student->image) }}" alt=".">
